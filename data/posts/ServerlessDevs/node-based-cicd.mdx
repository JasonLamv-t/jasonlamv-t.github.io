---
title: Serverless-Devs 实践——基于 Node 的前端 CICD
date: '2021-07-04'
tags: ['NodeJS', 'Serverless', 'Serverless-Devs', 'Aliyun', 'CI/CD']
summary: Serverless Devs 是一个开源开放的 Serverless 开发者平台，致力于为开发者提供强大的工具链体系。通过该平台，开发者可以一键体验多云 Serverless 产品，极速部署 Serverless 项目。本文介绍通过 Serverless-Devs 部署一个前端 CICD 系统。
---
