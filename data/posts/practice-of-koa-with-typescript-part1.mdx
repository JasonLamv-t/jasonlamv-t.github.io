...
summary: 最近闲来无事，于是决定对 Koa 框架进行简单的熟悉，并了解和使用一些包。本文介绍了一个基于 TS 的 Koa 项目如何从 0 开始搭建。
---
...
3. 创建 /src/config/index.ts:
   ...
   dotenv.config() // 将.env 中配置的环境变量读取到 process.env 中，https://github.com/motdotla/dotenv
